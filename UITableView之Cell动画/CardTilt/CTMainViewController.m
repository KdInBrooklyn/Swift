...
//https://www.raywenderlich.com/49311/advanced-table-view-animations-tutorial-drop-in-cards
...
@property (assign, nonatomic) CATransform3D initialTransform;      //给cell添加旋转动画
@property (strong, nonatomic) NSMutableSet *shownIndexs;           //用来记录已经展示过动画的cell下标
...
//    card.layer.transform = self.initialTransform;
//    card.layer.opacity = 0.8;
    
    
//    cell.contentView.layer.transform = self.initialTransform;
//    cell.contentView.layer.opacity = 0.8;
    
    return cell;
}


#pragma mark: - 在willDisplayCell这个方法里给cell的layer添加动画
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
//    cell.contentView.layer.transform = self.initialTransform;
//    cell.contentView.layer.opacity = 0.8;
//
    
    if (![self.shownIndexs containsObject:indexPath]) {
        [self.shownIndexs addObject:indexPath];
